...
# Import the BBMD results, the location is the folder of Figure S1/Results
...
pathway.mice <- readRDS(file = "KEGG mice sig.RDS") #The KEGG analysis results are in the folder of Figure S2/Results and Figure S3/Results
...
Css <- readRDS(file = "Css simulation.RDS") #Css simulation is in the folder of Table 1/Results
...
saveRDS(RfD.sigpath.df,file = "Human RfD for significant pathways.RDS")
...
saveRDS(HED.duration.df, file = "Human duration HED.RDS")
saveRDS(RfD.duration.df, file = "Human duration RfD.RDS")
