...
#Loading human RfD (The location is Figure 3/Results)
...
plot.CA <- ggplot()+
  ...
  ylab(expression(paste(log[10],"[RfD (ng/kg/day)]")))+ #y-axis labeling
...
legend <- get_legend(plot.CL + theme(legend.box.margin = margin(0,0,0,12)))
