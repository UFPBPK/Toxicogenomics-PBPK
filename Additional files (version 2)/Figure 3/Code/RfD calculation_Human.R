...
# Import the BBMD results, the location is in the folder of Figure S1/Results
...
# Import the KEGG results, the location is in the folder of Figure S2/Results and Figure S3/Results
...
Css <- readRDS(file = "Css simulation.RDS") # Css results are in the Table 1/Results
