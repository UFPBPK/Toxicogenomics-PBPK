...
# Import the BBMD results, the location is the folder of Figure 2/Results
...
pathway.mice <- readRDS(file = "KEGG mice sig.RDS") #The KEGG analysis results are in the folder of Figure 3/Results
...
Css <- readRDS(file = "Css simulation.RDS") #Css simulation is in the folder of Table 2/Results
