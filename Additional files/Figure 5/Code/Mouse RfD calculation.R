...
#AUC results are located in the folder of Table 2/Results
...
BBMD <- read.csv(file ="BBMD result mice.csv") # "BBMD result mice.csv" is in the folder of Figure 2/Results
BBMD.sig <- BBMD %>% filter(BMDU.BMDL < 40 & bmd < 10)

KEGG.m <- readRDS(file = "KEGG mice sig.RDS") # "KEGG mice sig.RDS" is in the folder of Figure 3/Results
